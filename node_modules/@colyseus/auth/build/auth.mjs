...
import "express-jwt";
import { oAuthProviderCallback, oauth } from "./oauth.mjs";
...
var getDirname = () => typeof __dirname !== "undefined" ? __dirname : path.dirname(fileURLToPath(import.meta.url));
