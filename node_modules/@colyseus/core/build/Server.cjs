...
__export(Server_exports, {
  ...
  registerRoomDefinitions: () => registerRoomDefinitions,
  unregisterRoomDefinitions: () => unregisterRoomDefinitions
});
...
function isRegisteredHandler(value) {
  return value instanceof import_RegisteredHandler.RegisteredHandler || typeof value === "object" && value !== null && "klass" in value;
}
